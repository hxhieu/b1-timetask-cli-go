...
type timeCreateCmd struct {
	...
	CalendarTitleTemplate *string `optional:"" help:"The calendar event title template for parsing the task details. Ignored if --input-type=file. Optional: Default to '[TT:{task_code}]{task_desc}', for example '[TT:11238]Improve documentation'" default:"[TT:{task_code}]{task_desc}"`
